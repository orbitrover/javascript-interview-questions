...
> Click :star:if you like the project and follow [@OrbitRover](https://github.com/orbitrover) for more updates. Coding questions available [here](#coding-exercise). Check [DataStructures and Algorithms](https://github.com/orbitrover/datastructures-algorithms) for DSA related questions and [ECMAScript](https://github.com/orbitrover/ECMAScript-features) for all ES features.).
...
1. ### What are the possible ways to create objects in JavaScript
   ...
   4. **Function constructor:**
      ...
      var object = new Person("orbitrover");
      ```
   ...
   5. **Function constructor with prototype:**
      ...
      ```javascript
      function Person() {}
      Person.prototype.name = "orbitrover";
